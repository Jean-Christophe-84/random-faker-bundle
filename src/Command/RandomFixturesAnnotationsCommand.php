    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($metaData as $meta) {
            $entities[$meta->getReflectionClass()->getShortName()] = [
                ...
                'columns'      => [],
                'name'         => $meta->getName(),
                'number'       => $this->fixtureHelper->getAnnotationParameter($meta->getName(), FakerNumber::class, 'number'),
                'order'        => $this->fixtureHelper->getAnnotationParameter($meta->getName(), FakerOrder::class, 'order'),
            ...
            foreach ($meta->getAssociationMappings() as $fieldName => $mapping) {
                $entities[$meta->getReflectionClass()->getShortName()]['associations'][$fieldName] = [
                    ...
                    'nullable'     => $this->fixtureHelper->isAssociationNullableAnnotation($meta->getName(), $fieldName),
            ...
            foreach ($meta->getFieldNames() as $fieldName) {
                $entities[$meta->getReflectionClass()->getShortName()]['columns'][$fieldName] = [
                    'annotations'    => $this->fixtureHelper->getAnnotationsForEntity($meta->getName(), $fieldName),
                    'generatedValue' => $this->fixtureHelper->isGeneratedValueAnnotation($meta->getName(), $fieldName),
